...
(``peer0.org1.hlc.com`` & ``peer0.org2.hlc.com``).  Secondly, we point to
...
.. code:: bash
  ...
  b568de3fe931        dev-peer1.org2.hlc.com-mycc-1.0   "chaincode -peer.a..."   4 minutes ago       Up 4 minutes                                                           dev-peer1.org2.hlc.com-mycc-1.0
  17c1c82087e7        dev-peer0.org1.hlc.com-mycc-1.0   "chaincode -peer.a..."   4 minutes ago       Up 4 minutes                                                           dev-peer0.org1.hlc.com-mycc-1.0
  0e1c5034c47b        dev-peer0.org2.hlc.com-mycc-1.0   "chaincode -peer.a..."   4 minutes ago       Up 4 minutes                                                           dev-peer0.org2.hlc.com-mycc-1.0
  71339e7e1d38        hyperledger/fabric-peer               "peer node start -..."   5 minutes ago       Up 5 minutes        0.0.0.0:8051->7051/tcp, 0.0.0.0:8053->7053/tcp     peer1.org1.hlc.com
  add6113ffdcf        hyperledger/fabric-peer               "peer node start -..."   5 minutes ago       Up 5 minutes        0.0.0.0:10051->7051/tcp, 0.0.0.0:10053->7053/tcp   peer1.org2.hlc.com
  689396c0e520        hyperledger/fabric-peer               "peer node start -..."   5 minutes ago       Up 5 minutes        0.0.0.0:7051->7051/tcp, 0.0.0.0:7053->7053/tcp     peer0.org1.hlc.com
  65424407a653        hyperledger/fabric-orderer            "orderer"                5 minutes ago       Up 5 minutes        0.0.0.0:7050->7050/tcp                             orderer.hlc.com
  ce14853db660        hyperledger/fabric-peer               "peer node start -..."   5 minutes ago       Up 5 minutes        0.0.0.0:9051->7051/tcp, 0.0.0.0:9053->7053/tcp     peer0.org2.hlc.com
...
-  ``peer0.org1.hlc.com`` and ``peer1.org1.hlc.com`` belong to Org1;
   ``peer0.org2.hlc.com`` and ``peer1.org2.hlc.com`` belong to Org2

-  These relationships are defined through the ``crypto-config.yaml`` and
   the MSP path is specified in our docker compose.

-  The anchor peers for Org1MSP (``peer0.org1.hlc.com``) and
   Org2MSP (``peer0.org2.hlc.com``) are then updated.  We do this by passing
   the ``Org1MSPanchors.tx`` and ``Org2MSPanchors.tx`` artifacts to the ordering
   service along with the name of our channel.

-  A chaincode - **chaincode_example02** - is installed on ``peer0.org1.hlc.com`` and
   ``peer0.org2.hlc.com``

-  The chaincode is then "instantiated" on ``peer0.org2.hlc.com``. Instantiation
   ...
   in a container by the name of ``dev-peer0.org2.hlc.com-mycc-1.0`` starting.
...
-  A query against the value of "a" is issued to ``peer0.org1.hlc.com``. The
   chaincode was previously installed on ``peer0.org1.hlc.com``, so this will start
   a container for Org1 peer0 by the name of ``dev-peer0.org1.hlc.com-mycc-1.0``. The result
   of the query is also returned. No write operations have occurred, so
   a query against "a" will still return a value of "100".

-  An invoke is sent to ``peer0.org1.hlc.com`` to move "10" from "a" to "b"

-  The chaincode is then installed on ``peer1.org2.hlc.com``

-  A query is sent to ``peer1.org2.hlc.com`` for the value of "a". This starts a
   third chaincode container by the name of ``dev-peer1.org2.hlc.com-mycc-1.0``. A
...
(like ``peer1.org1.hlc.com`` in the above example) . Finally, the chaincode is accessible
after it is installed (like ``peer1.org2.hlc.com`` in the above example) because it
...
.. code:: bash
    ...
    $ docker logs dev-peer0.org2.hlc.com-mycc-1.0
    04:30:45.947 [BCCSP_FACTORY] DEBU : Initialize BCCSP [SW]
    ex02 Init
    Aval = 100, Bval = 200

    $ docker logs dev-peer0.org1.hlc.com-mycc-1.0
    ...
    $ docker logs dev-peer1.org2.hlc.com-mycc-1.0
...
key for Org1 we would follow this path - ``crypto-config/peerOrganizations/org1.hlc.com/ca/``.
The private key is a long hash value followed by ``_sk``.  The path for Org2
would be - ``crypto-config/peerOrganizations/org2.hlc.com/ca/``.
...
.. code:: bash
  ...
  REPOSITORY                            TAG                              IMAGE ID            CREATED             SIZE
  dev-peer1.org2.hlc.com-mycc-1.0   latest                           4bc5e9b5dd97        5 seconds ago       176 MB
  dev-peer0.org1.hlc.com-mycc-1.0   latest                           6f2aeb032076        22 seconds ago      176 MB
  dev-peer0.org2.hlc.com-mycc-1.0   latest                           509b8e393cc6        39 seconds ago      176 MB
...
For the following CLI commands against `peer0.org1.hlc.com` to work, we need
to preface our commands with the four environment variables given below.  These
variables for ``peer0.org1.hlc.com`` are baked into the CLI container,
...
.. code:: bash
    ...
    CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.hlc.com/users/Admin@org1.hlc.com/msp
    CORE_PEER_ADDRESS=peer0.org1.hlc.com:7051
    CORE_PEER_LOCALMSPID="Org1MSP"
    CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.hlc.com/peers/peer0.org1.hlc.com/tls/ca.crt
...
.. code:: bash
    ...
    peer channel create -o orderer.hlc.com:7050 -c $CHANNEL_NAME -f ./channel-artifacts/channel.tx --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem
...
.. code:: bash
    ...
    # By default, this joins ``peer0.org1.hlc.com`` only
...
.. code:: bash
    ...
    peer chaincode instantiate -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n mycc -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02 -c '{"Args":["init","a", "100", "b","200"]}' -P "OR ('Org1MSP.member','Org2MSP.member')"
...
.. code:: bash
    ...
    peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem  -C $CHANNEL_NAME -n mycc -c '{"Args":["invoke","a","b","10"]}'
...
-  Install and instantiate the chaincode on ``peer0.org1.hlc.com``:

.. code:: bash

       # be sure to modify the $CHANNEL_NAME variable accordingly for the instantiate command

       peer chaincode install -o orderer.hlc.com:7050 -n marbles -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/marbles02
       peer chaincode instantiate -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/marbles02 -c '{"Args":["init"]}' -P "OR ('Org0MSP.member','Org1MSP.member')"
...
.. code:: bash
        ...
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["initMarble","marble1","blue","35","tom"]}'
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["initMarble","marble2","red","50","tom"]}'
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["initMarble","marble3","blue","70","tom"]}'
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["transferMarble","marble2","jerry"]}'
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["transferMarblesBasedOnColor","blue","jerry"]}'
        peer chaincode invoke -o orderer.hlc.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/hlc.com/orderers/orderer.hlc.com/msp/cacerts/ca.hlc.com-cert.pem -C $CHANNEL_NAME -n marbles -c '{"Args":["delete","marble1"]}'
...
You likely have chaincode images (e.g. ``dev-peer1.org2.hlc.com-mycc-1.0`` or
``dev-peer0.org1.hlc.com-mycc-1.0``) from prior runs. Remove them and try
again.
